...
namespace reapercore
{
    ...
    public:
        ...
        void draw() noexcept
        {
            ...
            if (!ImGui::Begin("##ReaperCoreMenu", nullptr, flags))
            {
                ImGui::End();
                return;
            }
    ...
    private:
        ...
        [[nodiscard]] const char* page_title() const noexcept
        {
            switch (m_page)
            {
            case Menu_Page::home: return "Home";
            case Menu_Page::self: return "Self";
            case Menu_Page::vehicle: return "Vehicle";
            case Menu_Page::world: return "World";
            case Menu_Page::network: return "Network";
            case Menu_Page::scripts: return "Scripts";
            case Menu_Page::misc: return "Misc";
            case Menu_Page::settings: return "Settings";
            }
            return "Home";
        }
